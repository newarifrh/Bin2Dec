...
-   Determining the decimal equivalent of a particular binary digit in the
    the sequence must be calculated using a single mathematical function, for
...
-   [Binary to Decimal converter using Android Studio](https://github.com/newarifrh/Bin2Dec)